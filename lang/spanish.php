...
$lang_day_of_week = array('Domingo', 'Lunes', 'Martes', 'Miércoles', 'Jueves', 'Viernes', 'Sábado');
...
$lang_date['lastcom'] = 'm/d/y \a \l\a\s H:i';
$lang_date['lastup'] = 'F d, Y';
$lang_date['register'] = 'F d, Y';
$lang_date['lasthit'] = 'F d, Y \a \l\a\s h:i A';
$lang_date['comment'] = 'F d, Y \a \l\a\s h:i A';
$lang_date['log'] = 'F d, Y \a \l\a\s h:i A';
...
$lang_common['owner_name'] = 'Nombre del propietario'; //cpg1.6
...
$lang_main_menu['home_title'] = 'Inicio';
...
$lang_version_alert['updates_available'] = 'Hay una versión más nueva de CPG disponible.';
$lang_version_alert['view_updates'] = 'Ver actualizaciones';

$lang_create_tabs['previous'] = 'Previo'; // cpg1.5
...
$lang_alb_select_box['only_empty_albums'] = 'Mostrar solo álbumes vacíos';
$lang_alb_select_box['all_albums'] = 'Mostrar todos los álbumes';
...
$lang_mailer['empty_message'] = 'Cuerpo del mensaje vacío';
...
$lang_mailer['invalid_address'] = 'Dirección inválida: ';
$lang_mailer['mailer_not_supported'] = ' programa de correo no soportado.';
$lang_mailer['provide_address'] = 'Debe proporcionar al menos una dirección de correo electrónico del destinatario.';
$lang_mailer['recipients_failed'] = 'SMTP Error: Los siguientes ';
$lang_mailer['signing'] = 'Firma de error: ';
$lang_mailer['smtp_connect_failed'] = 'La conexión SMTP () ha fallado.';
$lang_mailer['smtp_error'] = 'Error del servidor SMTP: ';
$lang_mailer['variable_set'] = 'No se puede establecer o restablecer la variable: ';
$lang_mailer['extension_missing'] = 'Falta extensión: ';
...
$lang_albmgr_php['upload_files'] = 'Subir archivos a este álbum'; // cpg1.6
}
...
$lang_bridgemgr_php['error_bridge_file_not_exist'] = 'El archivo Bridge no existe: %s';
...
$lang_bridgemgr_php['recovery_wait_content'] = 'Por razon de de seguridad no se permiten intentos fallidos muy seguidos (evitar ataques de fuerza bruta), de modo que tendrás que esperar un poco antes de volver a intentarlo.';
...
$lang_admin_php['view_a'] = 'Vistas ascendentes'; // cpg1.6
$lang_admin_php['view_d'] = 'Vistas descendentes'; // cpg1.6
...
$lang_admin_php['ascending'] = 'aAscendente';
...
$lang_admin_php['clickable_keyword_search'] = 'Mostrar la nube de palabras clave en la página de búsqueda';
$lang_admin_php['keyword_separator'] = 'Separador de palabras clave';
$lang_admin_php['keyword_convert'] = 'Convertir el separador de palabras clave';
$lang_admin_php['enable_plugins'] = 'Activar plugins';
$lang_admin_php['purge_expired_bans'] = 'Purgar expulsiones caducadas automáticamente';
$lang_admin_php['only_empty_albums'] = 'Agregar botón junto al cuadro desplegable del álbum para mostrar solo los álbumes vacíos';
$lang_admin_php['browse_batch_add'] = 'Interfaz navegable para añadir imágenes por lotes';
$lang_admin_php['batch_add_hide_existing_files'] = 'Ocultar archivos ya agregados en la interfaz de adición por lotes';
$lang_admin_php['batch_proc_limit'] = 'Procesos concurrentes para añadir imágenes por lotes';
$lang_admin_php['display_thumbs_batch_add'] = 'Mostrar miniaturas cuando se añaden imágenes por lotes';
$lang_admin_php['lang'] = 'Idioma por defecto'; // cpg1.5
$lang_admin_php['language_autodetect'] = 'Detectar idioma automáticamente'; // cpg1.5
$lang_admin_php['charset'] = 'Juego de caracteres';
// 'previous_next_tab'] = 'Mostrar enlaces siguiente/anterior en las páginas de tablas';
$lang_admin_php['theme'] = 'Tema (aspecto)';
...
$lang_admin_php['album_sort_order'] = 'Orden de clasificación para álbumes';
$lang_admin_php['link_pic_count'] = 'Mostrar número de archivos enlazados';
$lang_admin_php['link_last_upload'] = 'Considere el tiempo de carga de los archivos vinculados en la información del álbum'; // cpg1.6
...
$lang_admin_php['display_uploader'] = 'Mostrar el usuario que añadió el archivo'; // cpg1.5//$lang_admin_php['display_admin_uploader'] = 'Mostrar el usuario que añadió el archivo'; // cpg1.5
...
$lang_admin_php['custom_sortorder_thumbs'] = 'Mostrar botones de clasificación en la página de miniaturas';
$lang_admin_php['min_votes_for_rating'] = 'Mínimo número de votos para que un archivo aparezca el la lista de \'Más Valorados\' lista';
$lang_admin_php['picture_table_width'] = 'Ancho de la tabla de ficheros';
...
$lang_admin_php['ecard_captcha'] = 'Mostrar captcha (confirmación visual) para enviar eCards'; // cpg1.6
$lang_admin_php['ecard_flash'] = 'Permitir Flash en las Ecards';
$lang_admin_php['not_recommended'] = 'No recomendado';
$lang_admin_php['recommended'] = 'Recomendado';
...
$lang_admin_php['comment_akismet_group'] = 'Aplicar Akismet a los comentarios de'; // cpg1.5
...
$lang_admin_php['thumb_width'] = 'Dimensión mayor de una miniatura (anchura, si usas "Exacta" en "Usar dimensión")'; // cpg1.5
...
$lang_admin_php['upload_create_album_directory'] = 'Crear subdirectorio para cada álbum en usuarios\' Subir directorios'; // cpg1.6
...
$lang_admin_php['allow_user_upload_choice'] = 'Permitir a los usuarios elegir el método de subida';
$lang_admin_php['editpics_ignore_newer_than'] = 'Mostrar archivos cargados anteriormente en el formulario de edición de archivos después de cargar HTML5/flash';
$lang_admin_php['allow_duplicate_emails_addr'] = 'Permitir a dos usuarios tener el mismo correo';
$lang_admin_php['upl_notify_admin_email'] = 'Notificar al administrador que hay archivos añadidos esperando autorización';
$lang_admin_php['user_manager_hide_file_stats'] = 'Ocultar el recuento de archivos y el uso del espacio en disco en el administrador de usuarios'; // cpg1.6
...
$lang_admin_php['album_uploads_default'] = 'Valor predeterminado para la propiedad del álbum "Los visitantes pueden cargar archivos"'; // cpg1.6
...
$lang_admin_php['log_ecards'] = 'Registrar los sucesos de eCards'; // cpg1.5
...
$lang_admin_php['config_setting_rangerr'] = 'El valor que ha establecido para &laquo;%s&raquo; está fuera del rango permitido, revíselo.';
...
$lang_admin_php['warning_dont_submit'] = 'Si no estás seguro del impacto que tendrá cambiar ese valor no envíes el formulario y revisa la documentación antes.'; // cpg1.5 //
$lang_admin_php['warning_just_new_albums'] = 'Esta opción se aplica solo a los álbumes nuevos y no afecta a los álbumes existentes.'; // cpg1.6
...
$lang_db_input_php['com_updated'] = 'Comentario actualizado';
...
$lang_display_image_php['confirm_del'] = 'Estas seguro de querer BORRAR este archivo?\\También se borrarán comentarios.'; // js-alert
$lang_display_image_php['del_pic'] = 'Borrar este archivo';
$lang_display_image_php['size'] = '%s x %s píxeles';
...
$lang_ecard_php['title'] = 'Enviar una e-Card';
$lang_ecard_php['invalid_email'] = 'Aviso: dirección de correo no válida:'; // cpg1.5
$lang_ecard_php['ecard_title'] = '%s te ha enviado una e-Card';
$lang_ecard_php['error_not_image'] = 'Sólo se pueden enviar imágenes en las e-Cards.'; // cpg1.5
$lang_ecard_php['error_not_image_flash'] = 'Sólo se pueden enviar imágenes y archivos Flash en las e-Cards.'; // cpg1.5
...
$lang_ecard_php['send_success'] = 'e-Card enviada';
$lang_ecard_php['send_failed'] = 'Lo siento, pero el servidor no puede enviar tu e-Card...';
...
$lang_ecard_php['preview'] = 'Vista previa de la e-Card';
$lang_ecard_php['preview_button'] = 'Vista previa';
$lang_ecard_php['submit_button'] = 'Enviar e-Card';
$lang_ecard_php['preview_view_ecard'] = 'Este será el enlace alternativo a la e-Card una vez que se genere. No funciona en la vista previa.';
}
...
$lang_album_admin_menu['confirm_delete'] = '¿Estás seguro de querer BORRAR este album ? \\Se borrarán también todos los archivos y comentarios.'; // js-alert
...
$lang_list_users['n_pics'] = '%s Árchivo(s)';
...
$lang_install['dbase_create_btn'] = 'Crear';
$lang_install['dbase_create_db'] = 'Crear una Base de Datos nueva';
$lang_install['dbase_db_name'] = 'Nombre de la Base de Datos';
$lang_install['dbase_error'] = 'Error en la Base de Datos: ';
$lang_install['dbase_host'] = 'Servidor de la Base de Datos<br />(localhost normalmente)';
$lang_install['dbase_username'] = 'Usuario de la Base de Datos'; // cpg1.6
$lang_install['dbase_password'] = 'Contraseña de la Base de Datos'; // cpg1.6
$lang_install['dbase_no_create_db'] = 'No se pudo crear la Base de Datos.'; //1.6
$lang_install['dbase_no_sel_dbs'] = 'No se ha podido sacar la lista de Bases de Datos disponibles'; //1.6
$lang_install['dbase_succ'] = 'Conexión correcta con la base de datos'; //1.6
$lang_install['dbase_tbl_pref'] = 'Prefijo de las tablas'; //1.6
$lang_install['dbase_test_connection'] = 'Comprobar conexión'; //1.6
$lang_install['dbase_wrong_db'] = 'No ha podido encontrar una base de datos llamada \'%s\'. Por favor, comprueba el nombre'; //1.6
...
$lang_install['no_dbase_conn'] = 'No se pudo crear una conexión %s, verifique los detalles de %s ingresados.';
$lang_install['no_dbase_support'] = 'PHP no tiene habilitado el soporte de %s.';
...
$lang_install['sect_create_adm'] = 'Esta sección requiere información para crear su cuenta de administración de Coppermine. Utilice únicamente caracteres alfanuméricos. ¡Ingrese los datos con cuidado!';
$lang_install['sect_dbase_info'] = 'Esta sección requiere información sobre cómo acceder a su base de datos.<br />Si no sabe cómo llenarlos, consulte con el soporte de su proveedor de alojamiento web.';
$lang_install['sect_dbase_sel_db'] = 'Aquí debe elegir qué base de datos desea usar para Coppermine.<br />Si su cuenta de base de datos tiene los privilegios necesarios, puede crear una nueva base de datos desde el instalador o puede usar una base de datos existente. Si no le gustan ambas opciones, primero deberá crear una base de datos fuera del instalador de Coppermine, luego regresar aquí y luego seleccionar la nueva base de datos en el cuadro desplegable a continuación. También puede cambiar el prefijo de la tabla (sin embargo, no use puntos), pero se recomienda mantener el prefijo predeterminado.';
...
$lang_install['title_dbase_type'] = 'Seleccione el motor de Base de Datos para usar';
$lang_install['title_dbase_db_sel'] = '%s Selección de la Base de Datos';
$lang_install['title_dbase_pop'] = 'Creando la estructura de la Base de Datos';
$lang_install['title_dbase_user'] = 'Verificación de usuario de la Base de Datos';
...
$lang_install['try_again'] = '¡Inténtelo otra vez!';
...
$lang_install['pixels'] = 'Píxeles';
$lang_install['combine'] = 'Combinar dos imágenes';
$lang_install['text'] = 'Escribir texto en una imagen';
...
// 1.6 dbabstract
$lang_install['not_available'] = 'No disponible';
$lang_install['version_too_old'] = 'Versión demasiado vieja';
// 1.6.08 XML check
$lang_install['no_xml_parser'] = 'PHP debe estar habilitado para el análisis de XML';
}
...
$lang_pluginmgr_php['announcement_thread'] = 'Hilo de anuncio'; // cpg1.6

$lang_pluginmgr_php['plugin_action'] = 'Acción';	// cpg1.6
$lang_pluginmgr_php['saved_config'] = 'La configuración de &laquo;%s&raquo; ha sido salvada.';	// cpg1.6
$lang_pluginmgr_php['enable'] = 'Habilitar';	// cpg1.6
$lang_pluginmgr_php['disable'] = 'Deshabilitar';	// cpg1.6
}
...
$lang_rate_pic_php['fav_added'] = 'La imagen ha sido añadida a Favoritos.'; // cpg1.6
$lang_rate_pic_php['fav_removed'] = 'La imagen ha sido quitada de Favoritos.'; // cpg1.6
}
...
$lang_search_new_php['no_file'] = 'Ningún archivo seleccionado'; // cpg1.6
...
$lang_upload_php['err_no_method'] = 'Debe haber al menos un complemento de carga habilitado';
$lang_upload_php['auto_orient'] = 'Auto orientación de imágen(es)';
...
$lang_plugin_upload['js_require'] = 'SE REQUIERE JAVASCRIPT PARA QUE ESTE MÉTODO FUNCIONE.';
$lang_plugin_upload['albmSelMsg'] = 'Seleccione un álbum primero.';
$lang_plugin_upload['size_err'] = 'El archivo es más grande que el tamaño máximo permitido.';

// HTML5
$lang_plugin_upload_h5a['plug_desc'] = 'Agrega capacidades HTML5 de carga simultánea de múltiples archivos, incluido arrastrar y soltar';
$lang_plugin_upload_h5a['plug_info'] = 'Este complemento proporciona un método para cargas simultáneas de varios archivos usando HTML5 y javascript dentro de navegadores compatibles..';
$lang_plugin_upload_h5a['html5_method'] = 'Múltiples archivos - HTML5 (recomendado)';
$lang_plugin_upload_h5a['html5upload'] = 'Subir CoreH5A';
$lang_plugin_upload_h5a['title'] = 'Subir HTML5';

$lang_plugin_upload_h5a['upldfiles'] = 'Subir archivos';
$lang_plugin_upload_h5a['files'] = 'Archivos';
$lang_plugin_upload_h5a['flistitl'] = 'Usar el nombre del archivo como título';
$lang_plugin_upload_h5a['drop_files'] = 'O suelte archivos aquí';
$lang_plugin_upload_h5a['files_left'] = 'Archivos en cola: ';
$lang_plugin_upload_h5a['continue'] = 'Continue:';
$lang_plugin_upload_h5a['gotoedit'] = 'Editar archivos subidos';

$lang_plugin_upload_h5a['maxUplSiz'] = 'Tamaño máximo de archivo de carga';	//v1.3
$lang_plugin_upload_h5a['select'] = 'Número de cargas simultáneas';
$lang_plugin_upload_h5a['acptmime'] = 'Filtros de tipo Mime para la selección de archivos del navegador';
$lang_plugin_upload_h5a['autoedit'] = 'Ir automáticamente a editar después de que se complete la carga sin errores';
$lang_plugin_upload_h5a['incflds'] = 'Incluir campos:';
$lang_plugin_upload_h5a['saved'] = 'Su configuración ha sido guardada.';
$lang_plugin_upload_h5a['revert'] = 'Revertir al valor predeterminado';	//v1.3

$lang_plugin_upload_h5a['notavail'] = 'NO DISPONIBLE CON ESTE NAVEGADOR WEB';
$lang_plugin_upload_h5a['aborted'] = 'Abortado';
$lang_plugin_upload_h5a['type_err'] = 'No se puede cargar un archivo de este tipo. (extensión)';
$lang_plugin_upload_h5a['extallow'] = 'Solo se permiten archivos con las siguientes extensiones: ';

$lang_plugin_upload_h5a['q_stop'] = 'Detener la cola';
$lang_plugin_upload_h5a['q_resume'] = 'Reanudar la cola';
$lang_plugin_upload_h5a['q_cancel'] = 'Cancelar la cola';
//v1.3.2 chunked
$lang_plugin_upload_h5a['muf_err'] = 'Error al guardar el fragmento #%d para el archivo %s ( %s %s )';
$lang_plugin_upload_h5a['miss_chnk'] = 'Faltan fragmentos de archivos';
$lang_plugin_upload_h5a['dest_fail'] = 'No se puede crear el archivo de destino: %s';

// swf
$lang_plugin_upload_swf['plug_desc'] = 'Agrega capacidades de carga de múltiples archivos Flash';
$lang_plugin_upload_swf['plug_info'] = 'Este complemento proporciona un método para cargar varios archivos usando Flash y Javascript.';
$lang_plugin_upload_swf['swf_method'] = 'Multiple Archivos - Flash';
$lang_plugin_upload_swf['swfupload'] = 'Subir CoreSWF';
$lang_plugin_upload_swf['title'] = 'Subir Flash';

// single
$lang_plugin_upload_sgl['plug_desc'] = 'Agrega un método de carga de un solo archivo';
$lang_plugin_upload_sgl['plug_info'] = 'Este complemento proporciona un método para cargar un solo archivo.';
$lang_plugin_upload_sgl['sgl_method'] = 'Simple: un archivo a la vez';
$lang_plugin_upload_sgl['sglupload'] = 'Subir CoreSGL';
$lang_plugin_upload_sgl['title'] = 'Carga de un solo archivo';
$lang_plugin_upload_sgl['choose_file'] = 'Por favor elige un archivo.';
}
...
$lang_update_php['provide_admin_account_cpg'] = 'Por favor, proporciona las credenciales de tu cuenta de administrador de Coppermine'; // cpg1.6
$lang_update_php['provide_admin_account_dbase'] = 'Por favor, proporciona los datos de su cuenta %s'; // cpg1.6
$lang_update_php['try_again'] = 'Inténtalo otra vez'; // cpg1.5
$lang_update_php['dbase_connect_error'] = 'No se ha podido crear una conexión';
$lang_update_php['dbase_database_error'] = 'No se ha podido conectar a la Base de Datos: %s';
$lang_update_php['dbase_said'] = '%s dijo';
$lang_update_php['check_config_file'] = 'Por favor, comprueba %s detalles en %s';
$lang_update_php['performing_database_updates'] = 'Performing Database Updates';
$lang_update_php['performing_file_updates'] = 'Efectuando las actualizaciones de ficheros';
...
// 1.6 dbabstract
$lang_update_php['newDbMethod'] = 'Su instalación de Coppermine Gallery utiliza un método de conexión de base de datos (mysql) que está en desuso y debe cambiarse. Elija un método de conexión alternativo a continuación.';
$lang_update_php['not_available'] = 'No disponible';
$lang_update_php['version_too_old'] = 'Versión demasiado antigua';
$lang_update_php['recommended'] = ' (Recomendado)';
$lang_update_php['current_nr'] = ' (Actual, no recomendado)';
$lang_update_php['unable_write_config'] = 'No se puede escribir el archivo de configuración';
// 1.6 core upload plugins
$lang_update_php['core_upload_plugs'] = 'Habilitar complementos de carga principales';
// para el mecanismo de actualización/actualización con secuencias de comandos
$lang_update_php['no_zip_extn'] = 'La extensión que proporciona ZipArchive no está disponible';
$lang_update_php['files_placed_title'] = 'Actualizar archivos colocados';
$lang_update_php['files_placed_msg'] = 'Todos los archivos de actualización se colocaron con éxito. Haga clic a continuación para completar la actualización.';
$lang_update_php['complete_update'] = 'Actualización completa';
$lang_update_php['select_update'] = 'Seleccione la actualización a realizar.';
$lang_update_php['not_writeable'] = '<b>No se puede actualizar</b><br />Los siguientes directorios no se pueden escribir: ';
$lang_update_php['available_updates'] = 'Actualizaciones disponibles';
$lang_update_php['perform_update'] = 'Realizar actualización seleccionada';
$lang_update_php['no_updates_title'] = 'Actualización no disponible';
$lang_update_php['no_updates_msg'] = 'No hay actualizaciones disponibles para su versión';
$lang_update_php['not_found'] = 'Lanzamientos de CPG no encontrados en Github';
$lang_update_php['save_error'] = 'CNo se pudo guardar la nueva actualización. Operación abortada.';
$lang_update_php['pre_warning'] = '<span style="color:red">ADVERTENCIA: ¡Esta es una versión preliminar!</span>';
}
...
$lang_util_php['change_values_title'] = 'Cambiar valores para (o borrar) título, descripción y palabras clave.';
$lang_util_php['change_values_how'] = 'Establecer nuevos valores masivos para artículos o borrarlos.';
$lang_util_php['change_values_title_label'] = 'Título:';
$lang_util_php['change_values_desc_label'] = 'Descripción:';
$lang_util_php['change_values_tags_label'] = 'Palabras clave (usar punto y coma):';
$lang_util_php['change_values_msg_nothing'] = 'Nada que hacer.';
$lang_util_php['change_values_msg_changed'] = 'Se realizaron cambios en %d elementos.';
$lang_util_php['change_values_msg_error'] = 'Error al hacer cambios.';
...
$lang_util_php['nothing_deleted'] = 'No había nada que borrar.'; // cpg1.6
$lang_util_php['warnings'] = 'Advertencias'; // cpg1.6
$lang_util_php['errors'] = 'Errores'; // cpg1.6
$lang_util_php['complete'] = 'Acción Completa'; // cpg1.6
}
...
$lang_versioncheck_php['not_applicable'] = 'No aplicable'; // cpg1.5
$lang_versioncheck_php['no_repo_title'] = 'Sin datos de repositorio';
$lang_versioncheck_php['no_repo_message'] = 'No se pudo obtener información de verificación de versión del repositorio.';
}
